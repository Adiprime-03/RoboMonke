    ...
    while(r[i].stage != 8):
        ...
        if(len(corners) == 4):
            ...
            if(r[i].stage == 0):
                ...
                if(abs(r[i].position[1]-corner[1]) < 25):
                    print("S")
                ...
                if(abs(r[i].position[0]-corner[0]) < 10):
                    print("S")
                    s.sendto("S".encode(), (r[i].hostip, PORT))
                    r[i].stage = 6
                else:
                ...
                if(abs(r[i].position[1]-(dim[1]-r[i].start[1])) < 50):
                    print("S")
                    s.sendto("S".encode(), (r[i].hostip, PORT))
                    r[i].stage = 8
                else:
                    if(check == "straight"):
                        ...
                        if(len(xin) == 2 and xin[1] == xin[0]):
                            if(xin[1] > r[i].position[0]+10):
                                print("r", "V")
                                s.sendto("r".encode(), (r[i].hostip, PORT))
                                s.sendto("V".encode(), (r[i].hostip, PORT))
                            elif(xin[1] < r[i].position[0]-10):
                                print("V")
                                s.sendto("V".encode(), (r[i].hostip, PORT))
                            else:
                                print("r")
